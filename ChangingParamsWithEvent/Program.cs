namespace ChangingParamsWithEvent
{
    ...
    internal class Program
    {
        ...
        // Mthods for events
        private static void onParamChanged(object sender, ParamChanged e)
        {
            Console.WriteLine("The settings were successfully changed\n" +
                string.Format("After name changing Param ===> name: {0}; age: {1} ... Press Any key to continue",e.Name,e.Age));
            Console.ReadKey();
        }

        private static void OnParamChanging(object sender, ParamChanging e)
        {
            if (e.NewAge != 0)
            {
        ...
        private static void OnError(object sedner, Error e)
        {
